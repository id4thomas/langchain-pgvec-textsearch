"""
Indexing Script for Ko-StrategyQA Dataset

Creates:
- Table with corpus documents
- HNSW index for dense vector search
- BM25 index for sparse text search
...
def parse_args():
    parser = argparse.ArgumentParser(description="Index Ko-StrategyQA corpus")
...
async def main(exp: dict):
    ...
    print(f"\nIndexing complete: {len(docs)} {corpus_lang} documents indexed")
