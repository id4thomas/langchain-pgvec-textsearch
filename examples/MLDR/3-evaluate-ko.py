# %%
"""
Retrieval Evaluation Script for MLDR Dataset (Korean)

Uses:
- Korean queries from qrels TSV files
...
async def main(k_values: list[int] = [5, 10, 20], split: str = "test"):
    ...
    print(f"=== MLDR Korean Evaluation (text_config: {TEXT_CONFIG}) ===")
...
def print_results(all_results: dict, k_values: list[int]):
    ...
    print(f"\n{'='*70}")
    print(f"MLDR Korean EVALUATION RESULTS")
    print(f"{'='*70}")
