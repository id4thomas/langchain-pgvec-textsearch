# %%
"""
Retrieval Evaluation Script for MrTidy Dataset (Korean)

Uses:
- Korean queries (korean-queries)
...
async def main(k_values: list[int] = [5, 10, 20], split: str = "test"):
    ...
    print(f"=== MrTidy Korean Evaluation (text_config: {TEXT_CONFIG}) ===")
...
def print_results(all_results: dict, k_values: list[int]):
    ...
    print(f"\n{'='*70}")
    print(f"MrTidy KOREAN EVALUATION RESULTS")
    print(f"{'='*70}")
