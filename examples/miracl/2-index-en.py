"""
Indexing Script for MIRACL Dataset (English)

Creates:
- Table with English corpus from local miracl-corpus
...
async def main():
    ...
    # Load corpus from local JSONL files
    corpus_path = Path(settings.corpus_dir) / f"miracl-corpus-v1.0-{LANG}"
    print(f"Loading MIRACL corpus for language '{LANG}' from {corpus_path}...")
